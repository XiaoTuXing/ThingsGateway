...
public static partial class GatewayMapper
{
    ...
    public static partial UserSelectorOutput AdaptUserSelectorOutput(this AgvUser src);
    public static partial AgvUser AdaptAgvUser(this SysUser src);
    public static partial SysUser AdaptSysUser(this AgvUser src);
