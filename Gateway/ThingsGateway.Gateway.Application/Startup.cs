...
public class Startup : AppStartup
{
    public void Configure(IServiceCollection services)
    {
        ...
        services.AddSingleton<IAgvUserService, AgvUserService>();
        services.AddSingleton<IAgvRoleService, AgvRoleService>();
        services.AddSingleton<IAgvResourceService, AgvResourceService>();
        services.AddSingleton<IAgvPositionService, AgvPositionService>();
        services.AddSingleton<IAgvRelationService, AgvRelationService>();
